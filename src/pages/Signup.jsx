...
export default function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    if (!form.name || !form.email || !form.password || !form.confirmPassword || !form.zipCode) {
    ...
    <div className="min-h-screen bg-tt-cream flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-tt-forest">Create Account</h1>
          <p className="text-tt-charcoal/60 text-sm mt-1">Join Teriyaki Turf for personalized lawn care</p>
        </div>
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-tt-charcoal/40 mt-1">Used to personalize lawn care tips for your area</p>
            </div>
